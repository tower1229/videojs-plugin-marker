...
class MarkerPointTip extends Component {
   ...
   * @param {Object} options.data content of point tip
   */
...
class MarkerPoint extends Component {
   ...
   * @param {Object} options options
   * @param {number} options.offset offset form zero of video. unit(second)
   * @param {Object} options.data content of point
   */
  constructor(player, options) {
    super(player, options);
  ...
  updatePosition(duration) {
    DEBUG && console.log(`[videojs-plugin-marker] point offset: ${this.offset}, duration: ${duration}`)
